export const appointmentsR = [
    {
      title: 'Website Re-Design Plan',
      startDate: new Date(2023, 3, 17, 9, 35),
      endDate: new Date(2023, 3, 17, 11, 30),
      id: 0,
      location: 'Room 1',
    }, {
      title: 'Book Flights to San Fran for Sales Trip',
      startDate: new Date(2023, 3, 18, 12, 11),
      endDate: new Date(2023, 3, 19, 13, 0),
      id: 1,
      location: 'Room 1',
    }, 
    // {
